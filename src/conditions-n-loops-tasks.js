...
function getNearestBigger(number) {
  const maxPossibleNumber = [...String(number)].sort((a, b) => b - a).join('');

  for (let i = number + 1; i < maxPossibleNumber; i += 1) {
    if (maxPossibleNumber === [...String(i)].sort((a, b) => b - a).join('')) {
      return i;
    }
  }
